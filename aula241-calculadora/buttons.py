...
class ButtonsGrid(QGridLayout):
    ...
    def _makeGrid(self):
        ...
        for rowNumber, rowData in enumerate(self._gridMask):
            for colNumber, buttonText in enumerate(rowData): 
                ...
                if not isNumOrDot(buttonText) and buttonText != '':
    ...
    def _configLeftOp(self, text):
        displayText = self.display.text() # Deverá ser o número da esquerda
        ...
        # Se não tiver número da esquerda, não fazemos nada, apenas aguardemos o número da direita
